...
const puppeteerManager = require('../puppeteer/puppeteer-manager.js'); // Importamos el manager
...
ipcMain.on('ejecutar-automatizacion', async (event, tipoAutomatizacion) => {
    try {
        // const datosProcesados = comunicacionConFactura(resultadoCodigo);
        ...
        const resultado = await manager[accion](page, resultadoCodigo);
